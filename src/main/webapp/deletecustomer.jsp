...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Delete User profile</a>
			<button
...
<br>
   ...
   Name <input type="text"  name= "name" value="<%=uname %>" readonly ><br>
   
   Password <input type="text"  name= "pass"value="<%=upwd %>" readonly ><br>
   
   Email <input type="text"  name= "email" value="<%=uemail %>" readonly ><br>
   
   phone <input type="text"  name= "phone" value="<%=umobile %>" readonly ><br>
   
              <button class="buttonup button2" name= "submit">Delete my Account</button>
