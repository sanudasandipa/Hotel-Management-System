...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Update User profile</a>
			<button
...
<br>
   ...
   Name <input type="text"  name= "name" value="<%=uname %>" ><br>
   
   Password <input type="text"  name= "pass"value="<%=upwd %>" ><br>
   
   Email <input type="text"  name= "email" value="<%=uemail %>" ><br>
   
   Phone <input type="text"  name= "phone" value="<%=umobile %>" ><br>
   
              
              
              <button class="buttonup button2" name= "submit">Update Account</button>
